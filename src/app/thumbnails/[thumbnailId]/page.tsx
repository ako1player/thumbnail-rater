...
export default function ThumbnailPage(){
    ...
    const voteOnThumbnail = useMutation(api.thumbnail.voteOnThumbnail)
    const thumbnail = useQuery(api.thumbnail.getThumbnail, {
        thumbnailId,
    })
    ...
    function getVotePercent(imageId: string){
        ...
        return getVotesFor(imageId) / totalVotes *100;
    }
        ...
        <div className="mt-16">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="flex flex-col gap-4 items-center">
                    ...
                    : 
                    <Button
                    onClick={()=> {voteOnThumbnail({thumbnailId, imageId: firstImageId})}}
                    size="lg" className="w-fit">Vote A</Button>
                    }
                </div>
                <div className="flex flex-col gap-4 items-center">
                    ...
                    : 
                    <Button
                    onClick={()=> {voteOnThumbnail({thumbnailId, imageId: secondImageId})}}
                    size="lg" className="w-fit">Vote B</Button>
                    }
                </div>
            </div>
        </div>
